...
rem Copyright 2009-2010 UnboundID Corp.
rem All Rights Reserved.
rem
rem -----
rem
rem Copyright (C) 2009-2010 UnboundID Corp.
...
:runTool
"%JAVA_CMD%" %JAVA_ARGS% -cp "%BATDIR%\..\unboundid-ldapsdk-se.jar" com.unboundid.ldap.sdk.examples.AuthRate %*
