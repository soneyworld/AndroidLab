...
\frame{
 ...
 \begin{block}{Aufgaben}
    \begin{itemize}
        \item Gibt es funktionierende LDAP Bibliotheken für Java/Android?
...
\frame{
	\frametitle{Stand der Dinge}
 	  ...
 	  \begin{block}{Bisherige Ergebnisse}
   	      \begin{itemize}
                  \item Zwei LDAP Bibliotheken für Java
                    \begin{itemize}
                      \item JOpenLDAP
                      \item LDAP SDK von UnboundID
                    \end{itemize}
                  \item Struktur der Anwendung ist festgelegt
                  \item Primäre Funktionen sind definiert
                  \item Importieren/Exportieren/Synchronisieren in Arbeit
                  \item Prototyp der grafischen Oberfläche erstellt
                  \item LDAP Server noch nicht aufgsetzt
                   \begin{itemize}
                      \item Testen der Verbindung bisher mit öffentlichen LDAP Verzeichnissen
                    \end{itemize}
                \end{itemize}
           \end{block}
}
...
\begin{block}{RawContacts}
 ...
 \end{block}
   ...
   \begin{block}{ContentProvider}
	...
	\item Gibt den Mime Type zurück, den der gefundene Datensatz hat
    \end{itemize}
 \end{block}
}
